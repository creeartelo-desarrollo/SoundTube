...
toastr.options = {"positionClass": "toast-top-full-width","closeButton":true,"showDuration":330,"hideDuration":330}
jQuery.fn.resetear = function () {
  $(this).each (function() { this.reset(); });
  $(this).find("input[type='hidden']").val("");
}
$(document).on("click","form button[type=reset]",function(){
  $(this).closest("form").resetear();
});

// FUNCIONES DE LA APP
// MARCAR NOTIFICACION COMO LEIDA
$(document).on("click",".notifications-menu .set-leido",function(){
	var noti = $(this).closest("li");
	var Id_Notificacion = $(this).prev(".Id_Notificacion").val();
	console.log(Id_Notificacion)
	$.ajax({
		url: base_url+"admin/marcarLeido",
...
function actualizaNotys(operacion){
  var numnotys = parseInt($("#num-notys").text());
  if(operacion == "suma"){
    nownotys = numnotys + 1;
...
$("#frmpassw").validate({
    ...
    submitHandler: function() {
      $.ajax({
        data: $("#frmpassw").serialize(),
        url: base_url+"admin/cambiarContrasena",
        type: "post",
        beforeSend: function(){
          $("frmpassw .spinner").css("opacity",1);
          able("frmpassw",0);
        },
        success: function(html){
           $("#frmpassw .spinner").css("opacity",0);
          able("frmpassw",1);
          if(html.substring(0,4) === "_er:"){
            toastr.error(html.substring(4));
          }else if(html.substring(0,4) === "_wr:"){
            toastr.warning(html.substring(4));
