      ...
      <section class="content">
        <div style="width: 90%; margin:0 auto">
          ...
          <form id="frmevento" class="formularios-crud">
            <input type="hidden" name="Id_Evento" class="Id_Evento">
            <div class="spinner">Trabajando...</div>
            <div class="col-lg-6 col-md-6">
              <label>NOMBRE DEL SOLICITANTE</label>
              <input type="text" class="form-control" name="txtnombre" value="<?= $session["Nombres"] . ' ' . $session["Apellidos"]?>">
            </div>
            <div class="col-lg-6 col-md-6">
            ...
            <div class="col-lg-6 col-md-6">
              ...
              <input type="text" class="form-control" name="txtemail" value="<?= $session["Correo_Electronico"] ?>">
            </div>
            <div class="col-lg-6 col-md-6">
