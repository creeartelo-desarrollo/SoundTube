<div style="font-family: Arial; text-align: justify; width: 90%; margin: 30px auto;">
	...
	<p>
		Hola <strong><?= $evento->Nombres . " " . $evento->Apellidos ?></strong>, hemos agendado junto contigo un nuevo evento de <strong><?= $evento->TipoServicio ?>. <?= $evento->Sala ?></strong>
		Puedes consultarlo entrando a tu cuenta desde nuestra página <br>
