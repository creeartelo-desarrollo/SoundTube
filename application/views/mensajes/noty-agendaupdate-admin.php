<div style="font-family: Arial; text-align: justify; width: 90%; margin: 30px auto;">
	...
	<p>
		El evento de <strong><?= $evento->TipoServicio ?>. <?= $evento->Sala ?></strong>, del cliente <strong><?= $evento->Nombres . " " . $evento->Apellidos ?></strong> ha sido modificado por el usuario. 
