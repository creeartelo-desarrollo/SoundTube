<div style="font-family: Arial; text-align: justify; width: 90%; margin: 30px auto;">
	...
	<p>
		Hola <strong><?= $evento->Nombres . ", " . $evento->Apellidos ?></strong> hemos modificado tu evento de <strong><?= $evento->TipoServicio ?>. <?= $evento->Sala ?></strong>
		Puedes consultar los cambios entrando a tu cuenta desde nuestra página <br>
