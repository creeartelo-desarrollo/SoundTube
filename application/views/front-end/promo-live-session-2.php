...
<head>
	...
	<style type="text/css">
		body{background-image: url("<?= base_url('public/libs/front/images/background-promo-2.jpg') ?>");}
	</style>
	<!-- Facebook Pixel Code -->
	<script>
	...
	<section id="content">
		<!-- <div class="row"> -->
			<div class="columnas column large-6 medium-6" style="background-color: #fff">
				<img src="<?= base_url('public/libs/front/images/live-sessions-2.png') ?>" alt="Live Sessions SoundTube" class="img-responsive" style="width:210px">
				<img src="<?= base_url('public/libs/front/images/meses-sin-intereses.png') ?>" alt="Meses sin intereses Live Sessions" class="img-responsive" style="width:250px">
				<img src="<?= base_url('public/libs/front/images/pago-tarjeta.png') ?>" alt="Pago con tarjeta" style="width: 200px; margin-top: 18px" class="img-responsive">
				<h1 class="aprovecha">APROVECHA NUESTRA PROMOCIÓN DE LANZAMIENTO</h1>
				<h2 class="costo">$7,000.00</h2>
				<p class="info-gordo">
					Ingreso al estudio  9:00 AM <br>
					Entrega de material 
					terminado  6:00 PM
				</p>
				<p class="info">
			...
			<div class="columnas column large-6 medium-6">
				...
				<form id="frmcontacto" action="<?= base_url('welcome/enviarPromo') ?>">
					<input type="hidden"  name="hdnformulario" value="2">
